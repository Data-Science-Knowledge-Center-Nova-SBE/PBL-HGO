...
def unit(alertP1):
    ...
    CS=[3150502,3151407,3150503,3150572,4071200,4121300,3111400,3150604]

    usf_A=[2090771,3112271,3113274,3152002,4120400]
    usf_B=[3151572,3111172,3111174,3113271,3113672,3113871,3114272,3114471,3150109,3150371,3150501,3150571,3150573,3150600,3150603,3150671,3150672,3150772,3150773,3151104,3151409,3151500,3151571,3151573,3151574,3151575,3151576,3151601,3151603,3151671,3151672,3151771,3151772,3151871,3151872,3152001,3152403,3152471,3152671,4070571,4070671,4121571]
    ...
    alertP1['unit']=['USF A' if x in usf_A else 'USF B' if x in usf_B else 'UCSP' if x in UCSP_list else 'CS' if x in CS else 'outro' if x in outro else 'HGO' if x==0 else 'HOSP' for x in alertP1['COD_UNID_SAUDE_PROV']]
